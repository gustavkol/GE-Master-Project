...
- file full-custom-architecture/assembly_code_new.tceasm:       Assembly implementation of the delay application targeted for configuration 6.
...
For further development and generation of other processor configurations, the operations set database and hardware database provided by OpenASIP is needed. 
