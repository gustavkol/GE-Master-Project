...
vcom $coverage_opt -check_synthesis vhdl/extended_alu.vhdl || exit 1
vcom $coverage_opt -check_synthesis vhdl/fu_algo.vhdl || exit 1
vcom $coverage_opt -check_synthesis vhdl/fu_cordic.vhdl || exit 1
vcom $coverage_opt -check_synthesis vhdl/fu_algo_frac.vhdl || exit 1
...
vcom vhdl/tta0_imem_mau_pkg.vhdl || exit 1
vcom $coverage_opt -check_synthesis vhdl/sramrf_1wr_1rd_always_1.vhd || exit 1
vcom $coverage_opt -check_synthesis vhdl/xilinx_rams_14.vhd || exit 1
...
vcom $coverage_opt -check_synthesis gcu_ic/output_socket_5_1.vhdl || exit 1
...
vcom $coverage_opt -check_synthesis gcu_ic/input_mux_4.vhdl || exit 1
