...
// Calculates delay to reference point for all elements
void first_point_delay(unsigned char r_0, unsigned char angle, int *delay_array, int *inc_term_array) {
    ...
    compare_and_iter_first_point(delay_array[31], &delay_array[32], &a_next, &inc_term_next, &error_next, &inc_term_pos);
...
void second_point_delay(int *delay_array, int *a_array, int *inc_term_prev_array, int *error_array, int *inc_term_array) {
    ...
    compare_and_iter_second_point(&delay_array[32], a_array[31], &a_array[32], inc_term_prev_array[31], &inc_term_prev_array[32], &error_array[32], &inc_term_array[32]);
}
...
void next_point_delay(int *delay_array, int *a_array, int *inc_term_prev_array, int *error_array, int *inc_term_array) {
    ...
    compare_and_iter_next_point(&delay_array[32], &a_array[32], &inc_term_prev_array[32], &error_array[32], &inc_term_array[32]);
}
...
void init_delay_base(unsigned char r_0, unsigned char angle, int *delay_array, int *inc_term_array) {
    ...
    //     //compare_and_iter_first_point(delay_array[i], &delay_array[i+1], a_prev, &a_next, inc_term_prev, &inc_term_next,error_prev, &error_next, inc_term_pos);
